...
Anew-line character ends the preprocessing directive even if it occurs within what would otherwise be an invocation of a function-like macro.
...
The following macro names148)[fn:10]shall be defined by the implementation:
...
- =__STDC_VERSION__= :: The integer constant =199901L=.150)[fn:12]
...
[fn:7]Placemarker preprocessing tokens do not appear in the syntax because they are temporary entities that
