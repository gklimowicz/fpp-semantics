...
%left                   PERCENT "%"
%token                  PERIOD "."
%left                   PERIOD_AND_PERIOD ".and."
%left                   PERIOD_EQ_PERIOD ".eq."
%left                   PERIOD_EQV_PERIOD ".eqv."
%token                  PERIOD_FALSE_PERIOD ".false."
%left                   PERIOD_GE_PERIOD ".ge."
%left                   PERIOD_GT_PERIOD ".gt."
%left                   PERIOD_ID_PERIOD                /* user-defined operator */
%left                   PERIOD_LE_PERIOD ".le."
%left                   PERIOD_LT_PERIOD ".lt."
%left                   PERIOD_NE_PERIOD ".ne."
%left                   PERIOD_NEQV_PERIOD ".neqv."
%token                  PERIOD_NIL_PERIOD "nil."
%left                   PERIOD_NOT_PERIOD ".not."
%left                   PERIOD_OR_PERIOD ".or."
