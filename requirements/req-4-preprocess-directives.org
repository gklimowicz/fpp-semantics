...
Each requirement is a heading of the form ``One-line description'', and includes a unique identifier, its current status in the INCITS/Fortran approval process, and where the requirement came from (such as a standard, a meeting, email conversation).
