...
- =__STDC_ISO_10646__= :: An integer constant of the form =yyyymmL= (for example, =199712L=){{2011- , intended to indicate that values of type =wchar_t= are the coded representations of the characters}}{{2011+ . If this symbol is defined, then every character in the Unicode required set, when stored in an object of type =wchar_t=, has the same value as the short identifier of that character.}}{{2011+  The /Unicode required set/ consists of all the characters that are}} defined by ISO/IEC 10646, along with all amendments and technical corrigenda as of the specified year and month.{{2011+  If some other encoding is used, the macro shall not be defined and the actual encoding used is implementation-defined.}}
{{2011+
